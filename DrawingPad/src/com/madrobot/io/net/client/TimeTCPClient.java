 ...
 * {@link com.madrobot.io.net.client.SocketClient#connect connect } and call
 * either {@link #getTime getTime() } or {@link #getDate getDate() } to retrieve
 * the
 * time, then
 * call {@link com.madrobot.io.net.client.SocketClient#disconnect disconnect }
 * to
...
public final class TimeTCPClient extends SocketClient {
	 ...
	 * call {@link com.madrobot.io.net.client.SocketClient#disconnect
